...
import { ResepMakanan } from '../data/makanan'; import { ResepMinuman } from '../data/minuman'; import HeroSection from '../components/home/HeroSection'; import FeaturedMakananSection from  
...
Object.values(ResepMakanan.resep).slice(0, 3);  const featuredMinuman =  
Object.values(ResepMinuman.resep).slice(0, 2); 
 return ( 
 <div className="min-h-screen bg-gradient-to-br from blue-50 via-white to-indigo-50 pb-20 md:pb-8">  <HeroSection /> 
