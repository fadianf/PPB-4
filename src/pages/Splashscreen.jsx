...
import React, { useState, useEffect } from 'react'; import BackgroundPattern from  
...
export default function SplashScreen({ onComplete }) {  const [progress, setProgress] = useState(0);  const [isVisible, setIsVisible] = useState(true);  const [fadeIn, setFadeIn] = useState(false);  const [fadeOut, setFadeOut] = useState(false); 
 useEffect(() => { 
 setTimeout(() => { 
 setFadeIn(true); 
 }, 100); 
...
progress={progress} /> 
 ...
 <Footer fadeOut={fadeOut} fadeIn={fadeIn} />  </div> 
 ); 
}
